    ...
    def __init__(self):
        self.sprite_parameters = {
            'sprite_barrel': {
                ...
                'death_animation': deque([pg.image.load(f'sprites/barrel/death/{i}.png')
            ...
            'npc_devil': {
                ...
                'side': 50,
                'animation': [],
                'death_animation': deque([pg.image.load(f'sprites/devil/death/{i}.png')
            ...
            'npc_soldier0': {
                'sprite': [pg.image.load(f'sprites/npc/soldier0/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pg.image.load(f'sprites/npc/soldier0/death/{i}.png')
                ...
                'blocked': True,
                'flag': 'npc',
                'obj_action': deque([pg.image.load(f'sprites/npc/soldier0/action/{i}.png')
                                    .convert_alpha() for i in range(4)])
            },
        }
