...
void print_menu()
{
    ...
    puts("| 6.  Вывести таблицу с помощью массива ключей                                                                       |");
    ...
    puts("| 10. Отсортировать таблицу qsort'ом по стране-производителю                                                         |");
    ...
    do
    {
        ...
        switch (command)
        {
            ...
            case 1:
                ...
                rc = file_open((const FILE **const)&file, SMALL_FNAME, READ_MODE);
                if (rc != EXIT_SUCCESS)
                {
